...
export default function NavigationSidebar() {
  ...
  const navItems = [
    ...
    { name: 'Arena', href: '/assessments', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
  ...
  return (
    <div className="relative h-[calc(100vh-2rem)] w-64 bg-white rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col z-50 overflow-hidden">
      ...
      {/* Brand Logo */}
      <div className="p-6 transition-transform hover:scale-[1.02]">
      ...
      <div className="p-4 mt-auto">
        {user ? (
          <div className="flex items-center gap-3 p-3 rounded-[16px] border border-gray-100 bg-gray-50 group transition-all hover:border-gray-200">
            {/* Avatar */}
            {user.avatar ? (
              <img src={user.avatar} alt="Avatar" className="w-10 h-10 rounded-full object-cover shadow-sm bg-gray-200 border border-gray-200" />
            ) : (
